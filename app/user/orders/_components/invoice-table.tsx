        ...
        <Container>
            ...
            <div className="mt-10 w-full h-full p-10 mb-5 bg-white rounded-xl drop-shadow-lg">
                <table className="w-full border-collapse bg-white">
                    ...
                    <tr>
                        <td colSpan={3} rowSpan={3} className="border border-neutral-500">Грузоотправитель:
                            КУП &#34;МИНСКХЛЕБПРОМ&#34;</td>
                    ...
                    <tr>
                        <td colSpan={6} className="text-center border border-neutral-500">Распоряжение об оплате или
                            отказе от акцепта
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr className="text-center border border-neutral-500">
                        ...
                        <th colSpan={2} className="py-5 border border-neutral-500">Кол-во</th>
                        <th colSpan={2} className="py-5 border border-neutral-500">Цена</th>
                    ...
                    <tr className="font-bold">
                        ...
                        <td colSpan={2} className="text-right pr-2 border border-neutral-500">{totalQuantity}</td>
                        <td colSpan={2} className="pr-2 border border-neutral-500"></td>
                        ...
                        <td colSpan={2}
                            className="text-right pr-2 border border-neutral-500 rounded-br-xl">{(totalAmount + totalVatAmount).toFixed(2)}</td>
                    </tr>
                    {/*<tr>*/}
